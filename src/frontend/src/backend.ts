...
export class Backend implements backendInterface {
    ...
    async deleteMedicalFile(arg0: string): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteMedicalFile(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMedicalFile(arg0: string): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getMedicalFile(arg0);
    ...
    async listMedicalFiles(): Promise<Array<[string, ExternalBlob]>> {
        if (this.processError) {
            try {
    ...
    async updateLocation(arg0: string): Promise<void> {
        if (this.processError) {
            try {
...
function from_candid_opt_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_MLPrediction]): MLPrediction | null {
...
function from_candid_opt_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_BloodType]): BloodType | null {
    return value.length === 0 ? null : from_candid_BloodType_n16(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_EmergencyContact]): EmergencyContact | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        bloodType: record_opt_to_undefined(from_candid_opt_n15(_uploadFile, _downloadFile, value.bloodType)),
        dateOfBirth: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.dateOfBirth)),
        name: value.name,
        emergencyContact: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.emergencyContact)),
        ...
        company: record_opt_to_undefined(from_candid_opt_n14(_uploadFile, _downloadFile, value.company)),
